...
#Task: Draw a cube in 3D plane using GL_QUADS. Map keyboard inputs to rotation in X-axis, Y-axis and Z-axis. Also map keyboard functions to scale-up and scale-down the cube where Sx, Sy and Sz are 2.0 on each step.

# Hardcoded coordinates
X1, Y1, Z1 = -3.0, -3.0, -3.0
X2, Y2, Z2 = 3.0, 3.0, 3.0
...
def draw_cube_from_points(x1, y1, z1, x2, y2, z2):
    glBegin(GL_QUADS)
...
def display():
    ...
    draw_cube_from_points(X1, Y1, Z1, X2, Y2, Z2)
    glutSwapBuffers()
