...
#Task 1: Draw a pyramid in 3D plane using GL_QUADS, GL_TRIANGLES. Map keyboard inputs to rotation in X-axis, Y-axis and Z-axis. Also map keyboard functions to scale-up and scale-down the pyramid where Sx, Sy and Sz are 1.5 on each step.
